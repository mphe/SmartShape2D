...
@export var normal_length: float = 100.0 : set = _set_normal_length
@export var control_point_offset: float : set = _set_control_point_offset
@export var rotation_offset: float = 0.0 : set = _set_rotation_offset
@export var copy_scale: bool = false : set = _set_copy_scale
