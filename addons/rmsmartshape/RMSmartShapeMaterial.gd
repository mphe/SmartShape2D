...
# FIXME: Use @export_range(-1.0, 1.0) when https://github.com/godotengine/godot/issues/41183 gets fixed
@export var render_offset: float = 0.0 : set = _set_render_offset
...
# FIXME: Use @export_range(-1.5, 1.5) when https://github.com/godotengine/godot/issues/41183 gets fixed
@export var collision_offset: float = 0.0 : set = _set_collision_offset
# The amount the first and final quads extend past the texture (Does not apply to closed shapes)
# FIXME: Use @export_range(-1.0, 1.0) when https://github.com/godotengine/godot/issues/41183 gets fixed
@export var collision_extends: float = 0.0 : set = _set_collision_extends
