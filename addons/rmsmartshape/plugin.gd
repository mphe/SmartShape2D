...
func _ready():
    ...
    gui_edge_info_panel.visible = false
    gui_edge_info_panel.connect("on_set_material_override", Callable(self,"_on_set_edge_material_override"))
    gui_edge_info_panel.connect("on_set_render", Callable(self,"_on_set_edge_material_override_render"))
    gui_edge_info_panel.connect("on_set_weld", Callable(self,"_on_set_edge_material_override_weld"))
    gui_edge_info_panel.connect("on_set_z_index", Callable(self,"_on_set_edge_material_override_z_index"))
    gui_edge_info_panel.connect("on_set_edge_material", Callable(self,"_on_set_edge_material"))
